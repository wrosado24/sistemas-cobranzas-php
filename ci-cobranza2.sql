...
-- tabla de abogados
CREATE TABLE `ci-cobranza2`.lawyers (
...
CREATE TABLE `ci-cobranza2`.plaintiffs (
	id INT auto_increment NOT NULL,
	...
	department_id INT NULL,
	province_id varchar(100) NULL,
	district_id varchar(100) NULL,
	direccion varchar(100) NULL,
	celular varchar(100) NULL,
	CONSTRAINT plaintiffs_pk PRIMARY KEY (id)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_general_ci;

CREATE TABLE `ci-cobranza2`.loan_items_detail (
	id INT auto_increment NOT NULL,
	abono DOUBLE NOT NULL,
	loan_item_id INT NOT NULL,
	CONSTRAINT loan_items_detail_pk PRIMARY KEY (id)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `ci-cobranza2`.loans ADD nro_cta_bancaria varchar(50) NULL;
ALTER TABLE `ci-cobranza2`.loans ADD demandante INT NULL;
ALTER TABLE `ci-cobranza2`.loans ADD abogado_responsable INT NULL;
ALTER TABLE `ci-cobranza2`.loans ADD estado_demanda varchar(100) NULL;
ALTER TABLE `ci-cobranza2`.loans ADD localidad varchar(150) NULL;
ALTER TABLE `ci-cobranza2`.loans ADD lugar_trabajo varchar(100) NULL;
ALTER TABLE `ci-cobranza2`.loans ADD fecha_ing_juzgado varchar(50) NULL;
ALTER TABLE `ci-cobranza2`.loans ADD juzgado varchar(150) NULL;
